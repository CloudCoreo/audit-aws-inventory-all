...
@engine_bug_exclusions = {
  ...
  :Route53 => ["list_health_checks", "get_checker_ip_ranges", "list_geo_locations", "list_reusable_delegation_sets"],
  :SSM => ["describe_available_patches", "describe_patch_baselines", "list_documents"]
}
#"list_traffic_policy_instances","list_traffic_policies","list_hosted_zones",
@useless_methods = {
