...
@engine_bug_exclusions = {
  ...
  :Route53 => ["list_health_checks", "list_traffic_policy_instances","list_traffic_policies","get_checker_ip_ranges", "list_hosted_zones", "list_geo_locations", "list_reusable_delegation_sets"],
