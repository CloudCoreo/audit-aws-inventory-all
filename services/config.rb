...
coreo_aws_rule_runner "route53-inventory-runner" do
  action :run
  service :Route53
  rules ["route53-inventory-geo-locations", "route53-inventory-health-checks", "route53-inventory-hosted-zones", "route53-inventory-reusable-delegation-sets", "route53-inventory-traffic-policies", "route53-inventory-traffic-policy-instances"]
